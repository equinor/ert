...
def test_that_to24_creates_experiment_index(tmp_path):
    ...
    responses = {
        "summary": {"type": "summary", "name": "summary", "keys": ["FOPR"]},
        "gen_data": {"type": "gen_data", "name": "gen_data", "keys": ["SOME"]},
    }
    parameters = {
        "P1": {
            "type": "gen_kw",
    ...
    expected_experiment = {
        ...
        "response_configuration": [
            {"type": "summary", "name": "summary", "keys": ["FOPR"]},
            {"type": "gen_data", "name": "gen_data", "keys": ["SOME"]},
        ],
...
def test_that_migration_handles_empty_responses_json(tmp_path):
...
def test_that_migration_handles_empty_parameter_json(tmp_path):
...
def test_that_migration_handles_missing_observations_directory(tmp_path):
...
def test_that_migration_does_not_add_weights_when_missing_in_metadata(tmp_path):
