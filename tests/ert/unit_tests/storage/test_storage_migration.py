...
def test_that_storage_matches(
    ...
    with open_storage(storage_path, "w") as storage:
        ...
        assert experiment.parameter_configuration["PORO"].type == "field"
        assert experiment.parameter_configuration["BPR"].type == "gen_kw"
        assert experiment.parameter_configuration["TOP"].type == "surface"
