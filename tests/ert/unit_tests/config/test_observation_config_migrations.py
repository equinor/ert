...
@pytest.mark.usefixtures("use_tmpdir")
def test_that_general_observations_with_date_are_converted_to_restart():
    """
...
@pytest.mark.usefixtures("use_tmpdir")
def test_that_summary_observations_with_restart_are_converted_to_date():
    """
...
@pytest.mark.usefixtures("use_tmpdir")
def test_that_all_observation_types_are_migrated_correctly(tmp_path):
