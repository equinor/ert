...
async def poll(
    ...
    *,
    ...
    finished=None,
    handle_warning: Callable[[EnsembleEvaluationWarningEvent], None] | None = None,
):
    ...
    finished : Callable[[int, int], None]
        ...
        process.
    handle_warning : Callable[[EnsembleEvaluationWarningEvent], None]
        Called on EnsembleEvaluationWarningEvents from driver.
    ...
    try:
        while True:
            ...
            if isinstance(event, StartedEvent):
                ...
                isinstance(event, EnsembleEvaluationWarningEvent)
