...
TIME_MAP time_map
        ...
        # my_param = EclKW("MY_PARAM", grid.getGlobalSize(), EclDataType.ECL_FLOAT)
        # for i in range(grid.getGlobalSize()):
        #    my_param[i] = math.exp(2.5)
        # with cwrap.open("my_param.grdecl", mode="w") as f:
        #    grid.write_grdecl(my_param, f)
