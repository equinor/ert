...
class ErtKeywordTest(ErtTest):
    ...
    def keywordTest(
        self, name, argument_types, documentation_link, group, required=False
    ):
    ...
    def test_eclipse_keywords(self):
        ...
        self.keywordTest(
            "EQUIL_INIT_FILE", [PathArgument], "keywords/equil_init_file", "Eclipse"
        )
        self.keywordTest(
    ...
    def test_ensemble_keywords(self):
        ...
        self.keywordTest(
            "SELECT_CASE", [StringArgument], "keywords/select_case", "Ensemble"
        )
        self.keywordTest(
            "HISTORY_SOURCE", [StringArgument], "keywords/history_source", "Ensemble"
        )
        self.keywordTest("REFCASE", [PathArgument], "keywords/refcase", "Ensemble")
        self.keywordTest(
            "REFCASE_LIST", [StringArgument], "keywords/refcase_list", "Ensemble"
        )
        self.keywordTest("INCLUDE", [PathArgument], "keywords/include", "Ensemble")
        self.keywordTest(
            "OBS_CONFIG", [PathArgument], "keywords/obs_config", "Ensemble"
        )
        self.keywordTest(
            "RESULT_PATH", [PathArgument], "keywords/result_path", "Ensemble"
        )
        self.keywordTest(
            "LICENSE_PATH", [PathArgument], "keywords/license_path", "Ensemble"
        )

    def test_run_keywords(self):
        self.keywordTest(
            "INSTALL_JOB", [StringArgument, PathArgument], "keywords/install_job", "Run"
        )
        self.keywordTest(
            "DELETE_RUNPATH", [StringArgument], "keywords/delete_runpath", "Run"
        )
        self.keywordTest(
            "KEEP_RUNPATH", [StringArgument], "keywords/keep_runpath", "Run"
        )
        ...
        self.keywordTest(
            "FORWARD_MODEL", [StringArgument], "keywords/forward_model", "Run"
        )
        self.keywordTest("JOB_SCRIPT", [PathArgument], "keywords/job_script", "Run")
        self.keywordTest(
            "RUN_TEMPLATE",
            [PathArgument, StringArgument],
        ...
        self.keywordTest(
            "PRE_CLEAR_RUNPATH", [BoolArgument], "keywords/pre_clear_runpath", "Run"
        )
    ...
    def test_control_simulations_keywords(self):
        self.keywordTest(
            "MAX_RUNTIME",
            [IntegerArgument],
            "keywords/max_runtime",
            "Simulation Control",
        )
        self.keywordTest(
            "MIN_REALIZATIONS",
            [IntegerArgument, PercentArgument],
            "keywords/min_realizations",
            "Simulation Control",
        )
        self.keywordTest(
            "STOP_LONG_RUNNING",
            [BoolArgument],
            "keywords/stop_long_running",
            "Simulation Control",
        )
    ...
    def test_parametrization_keywords(self):
        ...
        self.keywordTest(
            "SUMMARY", [StringArgument], "keywords/summary", "Parametrization"
        )
        self.keywordTest(
            "SURFACE", [StringArgument], "keywords/surface", "Parametrization"
        )

    def test_enkf_control_keywords(self):
        self.keywordTest(
            "ENKF_ALPHA", [FloatArgument], "keywords/enkf_alpha", "Enkf Control"
        )
        self.keywordTest(
            "ENKF_BOOTSTRAP", [BoolArgument], "keywords/enkf_bootstrap", "Enkf Control"
        )
        self.keywordTest(
            "ENKF_FORCE_NCOMP",
            [BoolArgument],
            "keywords/enkf_force_ncomp",
            "Enkf Control",
        )
        self.keywordTest(
        ...
        self.keywordTest(
            "ENKF_RERUN", [BoolArgument], "keywords/enkf_rerun", "Enkf Control"
        )
        self.keywordTest(
            "RERUN_START", [IntegerArgument], "keywords/rerun_start", "Enkf Control"
        )
        self.keywordTest(
            "ENKF_TRUNCATION",
            [FloatArgument],
            "keywords/enkf_truncation",
            "Enkf Control",
        )
        self.keywordTest(
            "UPDATE_LOG_PATH",
            [PathArgument],
            "keywords/update_log_path",
            "Enkf Control",
        )
        self.keywordTest(
        ...
        self.keywordTest(
            "CONTAINER", [StringArgument], "keywords/container", "Enkf Control"
        )
    ...
    def test_analysis_module_keywords(self):
        ...
        self.keywordTest(
            "ANALYSIS_SET_VAR",
            [StringArgument, StringArgument, StringArgument],
            "keywords/analysis_set_var",
            "Analysis Module",
        )
        self.keywordTest(
            "ANALYSIS_COPY",
            [StringArgument, StringArgument],
            "keywords/analysis_copy",
            "Analysis Module",
        )
        self.keywordTest(
            "ITER_CASE",
        ...
        self.keywordTest(
            "ITER_COUNT", [IntegerArgument], "keywords/iter_count", "Analysis Module"
        )
        self.keywordTest(
            "STD_CUTOFF", [FloatArgument], "keywords/std_cutoff", "Analysis Module"
        )
        self.keywordTest(
            "SINGLE_NODE_UPDATE",
            [BoolArgument],
            "keywords/single_node_update",
            "Analysis Module",
        )
    ...
    def test_advanced_keywords(self):
        self.keywordTest(
            "DEFINE",
            [ProperNameArgument, StringArgument],
            "keywords/define",
            "Advanced",
        )
        self.keywordTest(
            ...
            [PathArgument],
            "keywords/schedule_prediction_file",
            "Advanced",
        )

    def test_queue_system_keywords(self):
        self.keywordTest(
            "QUEUE_SYSTEM", [StringArgument], "keywords/queue_system", "Queue System"
        )
        self.keywordTest(
            "QUEUE_OPTION",
            [StringArgument, StringArgument, StringArgument],
            "keywords/queue_option",
            "Queue System",
        )
        self.keywordTest(
            "LSF_SERVER", [StringArgument], "keywords/lsf_server", "Queue System"
        )
        self.keywordTest(
        ...
        self.keywordTest(
            "RSH_COMMAND", [PathArgument], "keywords/rsh_command", "Queue System"
        )
        self.keywordTest(
            "HOST_TYPE", [StringArgument], "keywords/host_type", "Queue System"
        )

    def test_plot_keywords(self):
        self.keywordTest(
            "IMAGE_VIEWER", [PathArgument], "keywords/image_viewer", "Plot"
        )
        self.keywordTest("IMAGE_TYPE", [StringArgument], "keywords/image_type", "Plot")
        self.keywordTest(
            "PLOT_DRIVER", [StringArgument], "keywords/plot_driver", "Plot"
        )
        self.keywordTest(
            "PLOT_ERRORBAR", [BoolArgument], "keywords/plot_errorbar", "Plot"
        )
        self.keywordTest(
            "PLOT_ERRORBAR_MAX", [IntegerArgument], "keywords/plot_errorbar_max", "Plot"
        )
        self.keywordTest("PLOT_WIDTH", [IntegerArgument], "keywords/plot_width", "Plot")
        self.keywordTest(
            "PLOT_HEIGHT", [IntegerArgument], "keywords/plot_height", "Plot"
        )
        self.keywordTest(
            "PLOT_REFCASE", [BoolArgument], "keywords/plot_refcase", "Plot"
        )
        self.keywordTest(
            "PLOT_REFCASE_LIST", [StringArgument], "keywords/plot_refcase_list", "Plot"
        )
    ...
    def test_workflow_keywords(self):
        self.keywordTest(
            "INTERNAL", [BoolArgument], "keywords/internal", "Workflow Jobs"
        )
        self.keywordTest(
            "FUNCTION", [StringArgument], "keywords/function", "Workflow Jobs"
        )
        self.keywordTest("MODULE", [PathArgument], "keywords/module", "Workflow Jobs")
        self.keywordTest(
            "EXECUTABLE", [PathArgument], "keywords/executable", "Workflow Jobs"
        )
        self.keywordTest(
            "MIN_ARG", [IntegerArgument], "keywords/min_arg", "Workflow Jobs"
        )
        self.keywordTest(
            "MAX_ARG", [IntegerArgument], "keywords/max_arg", "Workflow Jobs"
        )
        self.keywordTest(
            "ARG_TYPE", [StringArgument], "keywords/arg_type", "Workflow Jobs"
        )
        self.keywordTest(
            "LOAD_WORKFLOW_JOB",
            [StringArgument],
        ...
        self.keywordTest(
            ...
            [PathArgument],
            "keywords/workflow_job_directory",
            "Workflow Jobs",
        )
        self.keywordTest(
            "LOAD_WORKFLOW",
