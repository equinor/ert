...
from src.gui.model.node import NodeType
from src.gui.model.snapshot import COLUMNS, SnapshotModel, DURATION
...
@patch("src.gui.model.snapshot.datetime", wraps=datetime)
