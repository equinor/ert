...
from src.gui.tools import run_analysis
...
class RunAnalysisTests(ErtTest):
    def __init__(self, *args, **kwargs):
        ...
        with patch("src.gui.tools.run_analysis.run_analysis_tool.resourceIcon") as rs:
    ...
    @patch("src.gui.tools.run_analysis.run_analysis_tool.analyse", return_value=None)
    @patch("src.gui.tools.run_analysis.run_analysis_tool.QMessageBox")
    ...
    @patch(
        "src.gui.tools.run_analysis.run_analysis_tool.analyse",
