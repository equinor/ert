...
def runSimulator(simulator, history_simulator, time_step_count):
    """@rtype: Summary"""
    res_sum = Summary.writer("SNAKE_OIL_FIELD", datetime(2010, 1, 1), 10, 10, 10)

    res_sum.add_variable("FOPT")
    res_sum.add_variable("FOPR")
    res_sum.add_variable("FGPT")
    res_sum.add_variable("FGPR")
    res_sum.add_variable("FWPT")
    res_sum.add_variable("FWPR")
    res_sum.add_variable("FGOR")
    res_sum.add_variable("FWCT")

    res_sum.add_variable("FOPTH")
    res_sum.add_variable("FOPRH")
    res_sum.add_variable("FGPTH")
    res_sum.add_variable("FGPRH")
    res_sum.add_variable("FWPTH")
    res_sum.add_variable("FWPRH")
    res_sum.add_variable("FGORH")
    res_sum.add_variable("FWCTH")

    res_sum.add_variable("WOPR", wgname="OP1")
    res_sum.add_variable("WOPR", wgname="OP2")
    res_sum.add_variable("WWPR", wgname="OP1")
    res_sum.add_variable("WWPR", wgname="OP2")
    res_sum.add_variable("WGPR", wgname="OP1")
    res_sum.add_variable("WGPR", wgname="OP2")
    res_sum.add_variable("WGOR", wgname="OP1")
    res_sum.add_variable("WGOR", wgname="OP2")
    res_sum.add_variable("WWCT", wgname="OP1")
    res_sum.add_variable("WWCT", wgname="OP2")

    res_sum.add_variable("WOPRH", wgname="OP1")
    res_sum.add_variable("WOPRH", wgname="OP2")
    res_sum.add_variable("WWPRH", wgname="OP1")
    res_sum.add_variable("WWPRH", wgname="OP2")
    res_sum.add_variable("WGPRH", wgname="OP1")
    res_sum.add_variable("WGPRH", wgname="OP2")
    res_sum.add_variable("WGORH", wgname="OP1")
    res_sum.add_variable("WGORH", wgname="OP2")
    res_sum.add_variable("WWCTH", wgname="OP1")
    res_sum.add_variable("WWCTH", wgname="OP2")

    res_sum.add_variable("BPR", num=globalIndex(5, 5, 5))
    res_sum.add_variable("BPR", num=globalIndex(1, 3, 8))
