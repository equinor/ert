...
from tests.everest.generate_everest_configs import (
    generate_advanced_everest_config,
    generate_advanced_scipy_everest_config,
    generate_auto_scaled_controls_everest_config,
    generate_cvar_everest_config,
    generate_minimal_everest_config,
    generate_minimal_slow_everest_config,
    generate_multiobj_everest_config,
    generate_one_batch_everest_config,
    generate_remove_run_path_everest_config,
    generate_stddev_everest_config,
)
...
def test_generate_advanced_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_advanced_everest_config()
...
def test_generate_advanced_scipy_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_advanced_scipy_everest_config()
...
def test_generate_auto_scaled_controls_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_auto_scaled_controls_everest_config()
...
def test_generate_cvar_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_cvar_everest_config()
...
def test_generate_minimal_slow_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_minimal_slow_everest_config()
...
def test_generate_multiobj_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_multiobj_everest_config()
...
def test_generate_one_batch_config_same_as_existing_yml():
    ...
    stored_config = EverestConfig.load_file(path_to_config)
    stored_config.config_path = path_to_config
    config: EverestConfig = generate_one_batch_everest_config()
...
def test_generate_remove_run_path_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_remove_run_path_everest_config()
...
def test_generate_stddev_config_same_as_existing_yml():
    ...
    config: EverestConfig = generate_stddev_everest_config()
