                    ...
                    st.fixed_dictionaries(
                        {
                            ...
                            ConfigKeys.INIT_TRANSFORM: functions,
                            ConfigKeys.OUTPUT_TRANSFORM: functions,
                            # ConfigKeys.INPUT_TRANSFORM: functions, # only used in general!
                    ...
                    st.fixed_dictionaries(
                        {
                            ...
                            ConfigKeys.INPUT_FORMAT: st.just("ASCII"),
