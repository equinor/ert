...
class _Step(_StagesConfig):
    ...
    _set_input_from_list = validator('input', pre=True, always=True, allow_reuse=True)(
        _set_dict_from_list
    )
    _set_output_from_list = validator('output', pre=True, always=True, allow_reuse=True)(
        _set_dict_from_list
    )
