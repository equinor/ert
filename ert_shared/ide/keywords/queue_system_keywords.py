from ert_shared.ide.keywords.definitions import StringArgument, KeywordDefinition, IntegerArgument, PathArgument
from ert_shared.ide.keywords.definitions.configuration_line_definition import ConfigurationLineDefinition
