...
class EvaluatorServerConfig:
    def __init__(
        ...
        self.host, self.port, self._socket_holder = port_handler.find_available_port(
    ...
    def get_socket(self) -> socket.socket:
        return self._socket_holder.dup()
    ...
    def cleanup(self) -> None:
        if self._socket_holder is not None:
            self._socket_holder.close()
