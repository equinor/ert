...
from ert.ensemble_evaluator import identifiers, get_evaluation_id, serialization, Ensemble
...
class EnsembleEvaluation:
    def __init__(self, ensemble: Ensemble, iter_, evaluation_id, loop) -> None:
...
class EnsembleEvaluatorSession:
    ...
    def run_and_get_successful_realizations(self, evaluation_id: str) -> int:
        monitor = self.run(evaluation_id=evaluation_id)
