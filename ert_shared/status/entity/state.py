...
ALLOWED_ENSEMBLE_STATES_TRANSITIONS = [
    (ENSEMBLE_STATE_UNKNOWN, ENSEMBLE_STATE_STARTED),
    (ENSEMBLE_STATE_STARTED, ENSEMBLE_STATE_STOPPED),
    (ENSEMBLE_STATE_STARTED, ENSEMBLE_STATE_CANCELLED),
    (ENSEMBLE_STATE_STARTED, ENSEMBLE_STATE_FAILED),
]
