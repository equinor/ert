...
Please note, `config.ert` currently uses adaptive localization;
...
The following image shows conductivity field; from left to right:
prior, adaptive, distance and global localization

This example shows that the strength of the update is weakest on distance
localization while keeping the update strong within the vicinity of the observations.

![alt text](comp_loc.png)
