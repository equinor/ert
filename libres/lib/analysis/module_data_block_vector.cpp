...
UTIL_IS_INSTANCE_FUNCTION(module_data_block_vector,
                          MODULE_DATA_BLOCK_VECTOR_TYPE_ID)

module_data_block_vector_type *module_data_block_vector_alloc() {
    module_data_block_vector_type *module_data_block_vector =
        (module_data_block_vector_type *)util_malloc(
            sizeof *module_data_block_vector);
    UTIL_TYPE_ID_INIT(module_data_block_vector,
                      MODULE_DATA_BLOCK_VECTOR_TYPE_ID);
...
void module_data_block_vector_add_data_block(
    ...
    vector_append_owned_ref(module_data_block_vector->data_block_vector,
                            data_block, module_data_block_free__);
}
...
module_data_block_type *module_data_block_vector_iget_module_data_block(
    ...
    return (module_data_block_type *)vector_iget(
        module_data_block_vector->data_block_vector, index);
}
