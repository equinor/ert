...
typedef enum {
    ...
    /* S */ DGESVD_MIN_RETURN, /* Return the first min(m,n) vectors in U/VT. */
                               /* O */
    DGESVD_MIN_OVERWRITE, /* Return the first min(m,n) vectors of U/VT by overwriteing in A. */
    /* N */ DGESVD_NONE
} /* Do not compute any singular vectors for U/VT */
dgesvd_vector_enum;
...
void matrix_dgesvd(dgesvd_vector_enum jobv, dgesvd_vector_enum jobvt,
