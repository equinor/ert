...
enkf_config_node_type *ensemble_config_get_node(const ensemble_config_type *,
                                                const char *);
...
ensemble_config_type *ensemble_config_alloc_load(const char *, ecl_grid_type *,
                                                 const ecl_sum_type *);
ensemble_config_type *ensemble_config_alloc(const config_content_type *,
                                            ecl_grid_type *,
                                            const ecl_sum_type *);
PY_USED ensemble_config_type *
ensemble_config_alloc_full(const char *gen_kw_format_string);
void ensemble_config_init_SUMMARY_full(ensemble_config_type *, const char *,
                                       const ecl_sum_type *);
