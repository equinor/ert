...
enkf_config_node_type *enkf_config_node_alloc(enkf_var_type, ert_impl_type,
...
void enkf_config_node_update_container(enkf_config_node_type *config_node,
...
PY_USED enkf_config_node_type *enkf_config_node_alloc_GEN_PARAM_full(
...
PY_USED enkf_config_node_type *enkf_config_node_alloc_GEN_DATA_full(
...
PY_USED enkf_config_node_type *enkf_config_node_alloc_GEN_KW_full(
...
PY_USED enkf_config_node_type *enkf_config_node_alloc_SURFACE_full(
