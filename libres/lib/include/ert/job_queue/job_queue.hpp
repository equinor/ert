...
job_queue_type *job_queue_alloc(int, const char *ok_file,
...
PY_USED void job_queue_run_jobs_threaded(job_queue_type *queue,
                                         int num_total_run, bool verbose);
...
PY_USED void job_queue_set_max_job_duration(job_queue_type *queue,
