...
private:
    ...
    bool m_converged;
    int m_iteration_nr;
    Eigen::MatrixXd W; // Coefficient matrix used to compute Omega = I + W (I -11'/N)/sqrt(N-1)
    ...
    Eigen::MatrixXd E; // Prior ensemble of measurement perturations (should be the same for all iterations)
};
