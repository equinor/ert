...
Eigen::MatrixXd alloc_activeE(const data::Data *data);
Eigen::MatrixXd alloc_activeW(const data::Data *data);
Eigen::MatrixXd alloc_activeA(const data::Data *data);
...
void initX(const config::Config &ies_config, const Eigen::MatrixXd &S,
           const Eigen::MatrixXd &R, const Eigen::MatrixXd &E, const Eigen::MatrixXd &D,
           Eigen::MatrixXd &X);
