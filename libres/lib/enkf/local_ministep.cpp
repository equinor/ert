...
RES_LIB_SUBMODULE("local.local_ministep", m) {
    ...
    auto get_active_data_list = static_cast<ActiveList& (LocalMinistep::*)(const std::string&)>(&LocalMinistep::get_active_data_list);
    auto get_obs_data = static_cast<LocalObsData& (LocalMinistep::*)()>(&LocalMinistep::get_obsdata);

    py::class_<LocalMinistep>(m, "LocalMinistep")
        .def("hasActiveData", &LocalMinistep::data_is_active)
        .def("getActiveList", get_active_data_list, py::return_value_policy::reference_internal)
        ...
        .def("row_scaling", &LocalMinistep::get_row_scaling)
        .def("getLocalObsData", get_obs_data, py::return_value_policy::reference_internal)
        .def("have_obsdata", &LocalMinistep::have_obsdata)
        .def("name", &LocalMinistep::name)
        .def("get_obs_data", get_obs_data, py::return_value_policy::reference_internal)
