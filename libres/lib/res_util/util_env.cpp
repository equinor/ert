...
void util_unsetenv(const char *variable) { unsetenv(variable); }
...
void util_unsetenv(const char *variable) { util_setenv(variable, NULL); }
#endif
...
const char *util_update_path_var(const char *variable, const char *value,
                                 bool append) {
