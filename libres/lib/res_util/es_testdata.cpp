...
Eigen::MatrixXd es_testdata::alloc_state(const std::string &name) const {
    ...
    Eigen::MatrixXd state = Eigen::MatrixXd::Zero(state_size, this->active_ens_size);
