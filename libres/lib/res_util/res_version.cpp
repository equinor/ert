...
int res_version_get_major_version() { return RES_VERSION_MAJOR; }

int res_version_get_minor_version() { return RES_VERSION_MINOR; }

const char *res_version_get_micro_version() { return str(RES_VERSION_MICRO); }
