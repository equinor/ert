...
void test_update_default(const char *config_file, const char *job_file) {
    ert_test_context_type *test_context =
        ert_test_context_alloc("AnalysisJob0", config_file);
...
void test_update_new_case(const char *config_file, const char *job_file) {
    ert_test_context_type *test_context =
        ert_test_context_alloc("AnalysisJob1", config_file);
...
void test_update_new_case_step(const char *config_file, const char *job_file) {
    ert_test_context_type *test_context =
        ert_test_context_alloc("AnalysisJob2", config_file);
...
void test_update_new_case_step_selected(const char *config_file,
                                        const char *job_file) {
    ert_test_context_type *test_context =
        ert_test_context_alloc("AnalysisJob2", config_file);
