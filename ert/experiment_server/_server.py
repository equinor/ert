    ...
    async def handle_dispatch(
        ...
        async with self.count_dispatcher():
            async for msg in websocket:
                ...
                # TODO: there should be information in the cloud event identifying the
                # experiment, for now, dispatch to all experiments
                # TODO: the need for iter should be replaced by something in the
                # experiment?
                for experiment in self._registry.all_experiments:
                    await experiment.dispatch(event, 0)
