...
from src.gui.splash import ErtSplash
from src.gui.widgets import SummaryPanel, resourceIcon
import src.gui.widgets
from src.gui.main_window import GertMainWindow
from src.gui.simulation.simulation_panel import SimulationPanel
from src.gui.tools.export import ExportTool
from src.gui.tools.load_results import LoadResultsTool
from src.gui.tools.event_viewer import EventViewerTool
from src.gui.tools.event_viewer import GUILogHandler
from src.gui.tools.manage_cases import ManageCasesTool
from src.gui.tools.plot import PlotTool
from src.gui.tools.plugins import PluginHandler, PluginsTool
from src.gui.tools.run_analysis import RunAnalysisTool
from src.gui.tools.workflows import WorkflowsTool
...
def _start_window(ert: EnKFMain, notifier: ErtNotifier, args: argparse.Namespace):
    ...
    splash = ErtSplash(version_string=f"Version {src.gui.__version__}")
    splash.show()
    splash.repaint()
