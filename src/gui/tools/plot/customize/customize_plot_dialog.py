...
from src.gui.tools.plot.widgets import CopyStyleToDialog
from src.gui.widgets import resourceIcon
from src.gui.plottery import PlotConfig, PlotConfigHistory, PlotConfigFactory
from src.gui.tools.plot.customize.style_customization_view import StyleCustomizationView
from src.gui.tools.plot.customize import StatisticsCustomizationView
from src.gui.tools.plot.customize.default_customization_view import (
    DefaultCustomizationView,
)
from src.gui.tools.plot.customize.limits_customization_view import (
