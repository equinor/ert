...
from src.gui.widgets import resourceMovie
from src.gui.widgets.message_box import ErtMessageBox
from src.gui.model.job_list import JobListProxyModel
from src.gui.model.snapshot import RealIens, SnapshotModel, FileRole
from src.gui.simulation.tracker_worker import TrackerWorker
from src.gui.tools.file import FileDialog
from src.gui.tools.plot.plot_tool import PlotTool
...
from src.gui.simulation.view.progress import ProgressView
from src.gui.simulation.view.legend import LegendView
from src.gui.simulation.view.realization import RealizationWidget
