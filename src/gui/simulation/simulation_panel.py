...
from src.gui.widgets import addHelpToWidget, resourceIcon
from src.gui.simulation import EnsembleExperimentPanel, EnsembleSmootherPanel
from src.gui.simulation import SingleTestRunPanel
from src.gui.simulation import (
    IteratedEnsembleSmootherPanel,
    MultipleDataAssimilationPanel,
    SimulationConfigPanel,
)
from src.gui.simulation import RunDialog
