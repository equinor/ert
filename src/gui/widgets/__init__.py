...
def resourceIcon(name):
    ...
    return QIcon(resource_filename("src.gui", "resources/gui/img/" + name))
...
def resourceImage(name):
    ...
    return QPixmap(resource_filename("src.gui", "resources/gui/img/" + name))


def resourceMovie(name):
    """@rtype: QMovie"""
    movie = QMovie(resource_filename("src.gui", "resources/gui/img/" + name))
    movie.start()
    return movie
