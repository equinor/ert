...
from src.gui.widgets import resourceIcon, addHelpToWidget
from src.gui.widgets.validationsupport import ValidationSupport
...
class PathChooser(QWidget):
    ...
    def __init__(self, model, help_link=""):
        """
        :type model: ert_gui.widgets.models.path_model.PathModel
        :param help_link: str
        """
