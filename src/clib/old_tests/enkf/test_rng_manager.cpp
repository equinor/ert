...
void test_create() {
    rng_manager_type *rng_manager =
        rng_manager_alloc_load("file/does/not/exist");
...
void test_default() {
    ...
    test_assert_int_equal(rng_get_int(rng1_0, MAX_INT),
                          rng_get_int(rng2_0, MAX_INT));
    rng_get_int(rng3_0, MAX_INT);
    test_assert_int_equal(rng_get_int(rng1_0, MAX_INT),
                          rng_get_int(rng3_0, MAX_INT));

    test_assert_int_equal(rng_get_int(rng1_100, MAX_INT),
                          rng_get_int(rng2_100, MAX_INT));
    rng_get_int(rng3_100, MAX_INT);
    test_assert_int_equal(rng_get_int(rng1_100, MAX_INT),
                          rng_get_int(rng3_100, MAX_INT));

    test_assert_int_equal(rng_get_int(rng1, MAX_INT),
                          rng_get_int(rng2, MAX_INT));
...
void test_random() {
    ...
    test_assert_int_not_equal(rng_get_int(rng1_0, MAX_INT),
                              rng_get_int(rng2_0, MAX_INT));
    test_assert_int_not_equal(rng_get_int(rng1_100, MAX_INT),
                              rng_get_int(rng2_100, MAX_INT));
...
static void test_alloc() {
    ...
    test_assert_int_equal(rng_get_int(rng0_0, MAX_INT),
                          rng_get_int(rng1_0, MAX_INT));
    test_assert_int_equal(rng_get_int(rng0_42, MAX_INT),
                          rng_get_int(rng1_42, MAX_INT));

    test_assert_int_not_equal(rng_get_int(rng0_0, MAX_INT),
                              rng_get_int(rng_odd_0, MAX_INT));
    test_assert_int_not_equal(rng_get_int(rng0_42, MAX_INT),
                              rng_get_int(rng_odd_42, MAX_INT));
