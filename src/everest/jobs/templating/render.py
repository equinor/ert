...
def _load_input(input_files: Any) -> dict[str, Any]:
    data = {}
...
def _assert_input(input_files: Any, template_file: str, output_file: Any) -> None:
    for input_file in input_files:
...
def render(input_files: Any, template_file: str, output_file: str) -> None:
