...
def export_metadata(config: ExportConfig | None, optimization_output_dir: str):
    ...
    metadata = []
    for batch_info in (b for b in storage.data.batches):
        ...
        for real_tuple, data in realization_info.group_by("realization"):
            ...
            my_stuff = {
                ...
                MetaDataColumnNames.SIM_AVERAGED_OBJECTIVE: batch_info.batch_objectives[
                ...
                MetaDataColumnNames.SIMULATION: int(data["simulation_id"].item()),
                **objectives_dict,
                **controls_dict,
                MetaDataColumnNames.REAL_AVERAGED_OBJECTIVE: total_objective_value_for_real,
