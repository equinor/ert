...
class OptimalResult:
    ...
    def from_seba_optimal_result(
        o: Optional[sqlite_storage.OptimalResult] = None,
    ) -> "OptimalResult" | None:
        if o is None:
            return None
...
class BatchDataFrames:
    ...
    batch_objectives: Optional[polars.DataFrame]
    realization_objectives: Optional[polars.DataFrame]
    batch_constraints: Optional[polars.DataFrame]
    realization_constraints: Optional[polars.DataFrame]
    batch_objective_gradient: Optional[polars.DataFrame]
    perturbation_objectives: Optional[polars.DataFrame]
    batch_constraint_gradient: Optional[polars.DataFrame]
    perturbation_constraints: Optional[polars.DataFrame]
    is_improvement: Optional[bool] = False
...
class EverestStorageDataFrames:
    ...
    time_ended: Optional[datetime.date] = None
    initial_values: Optional[polars.DataFrame] = None
    objective_functions: Optional[polars.DataFrame] = None
...
class EverestStorage:
    def __init__(
        ...
        self._output_dir = output_dir
        self._merit_file: Optional[Path] = None
