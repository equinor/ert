...
class ControlConfig(BaseModel):
    ...
    perturbation_type: Literal["absolute", "relative"] = Field(
        ...
        description=dedent(
            ...
            **NOTE:** currently the dynamic range is computed with respect to
            all controls, so defining relative perturbation type for control
            types with different dynamic ranges might have unintended effects.
            """
        ),
    )
