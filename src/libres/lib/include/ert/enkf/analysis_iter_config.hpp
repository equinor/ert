...
typedef struct analysis_iter_config_struct analysis_iter_config_type;
  ...
  PY_USED char *                  analysis_iter_config_get_case_fmt( analysis_iter_config_type * config);
  analysis_iter_config_type *     analysis_iter_config_alloc();
  PY_USED analysis_iter_config_type * analysis_iter_config_alloc_full(const char * case_fmt, int num_iterations, int num_iter_tries);
