...
#include <ert/config/config_parser.hpp>
  ...
  PY_USED bool workflow_job_internal( const workflow_job_type * workflow_job );
  ...
  void           workflow_job_set_executable( workflow_job_type * workflow_job , const char * executable);
  PY_USED char * workflow_job_get_executable( workflow_job_type * workflow_job);

  void           workflow_job_set_internal_script( workflow_job_type * workflow_job , const char * script_path);
  PY_USED char* workflow_job_get_internal_script_path( const workflow_job_type * workflow_job);
  ...
  PY_USED char * workflow_job_get_function( workflow_job_type * workflow_job);
  void           workflow_job_set_module( workflow_job_type * workflow_job , const char * module);
  PY_USED char * workflow_job_get_module( workflow_job_type * workflow_job);
  void *         workflow_job_run( const workflow_job_type * job, void * self , bool verbose , const stringlist_type * arg);

  PY_USED int workflow_job_get_min_arg( const workflow_job_type * workflow_job );
  PY_USED int workflow_job_get_max_arg( const workflow_job_type * workflow_job );
  PY_USED config_item_types workflow_job_iget_argtype( const workflow_job_type * workflow_job, int index);
