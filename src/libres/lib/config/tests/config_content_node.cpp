  ...
  config_path_elm_type * cwd = config_path_elm_alloc( root_path , NULL );
  {
...

    {
      hash_type * opt_hash = hash_alloc( );
      {
        ...
        test_assert_string_equal( (const char *) hash_get( opt_hash , "KEY1" ) , "VALUE1" );
        test_assert_string_equal( (const char *) hash_get( opt_hash , "KEY3" ) , "VALUE3" );
      }
      ...
      test_assert_string_equal( (const char *) hash_get( opt_hash , "KEY2" ) , "VALUE2" );
      test_assert_string_equal( (const char *) hash_get( opt_hash , "KEY3" ) , "VALUE3" );
