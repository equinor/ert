...
cmake_policy(PUSH)
if(POLICY CMP0067)
  # pass CMAKE_CXX_STANDARD to check_cxx_source_compiles() has to appear before
  # including CheckCXXSourceCompiles module
...
if(CXX_FILESYSTEM_HAVE_FS)
  ...
  if(can_link)
    ...
    if(CXX_FILESYSTEM_NO_LINK_NEEDED)
      # on certain linux distros we have a version of libstdc++ which has the
      # final code for c++17 fs in the libstdc++.so.*. BUT when compiling with
      # g++ < 9, we MUST still link with libstdc++fs.a libc++ should not suffer
      # from this issue, so, in theory we should be fine with only checking for
      # GCC's libstdc++
