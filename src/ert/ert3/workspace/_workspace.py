...
class Workspace:
    ...
    def assert_experiment_exists(self, experiment_name: str) -> None:
        ...
        experiment_file = self._path / _EXPERIMENTS_BASE / f"{experiment_name}.yml"
    ...
    def export_json(
        ...
        Args:
            ...
            output_file (Union[str, pathlib.Path, None]):
                The name of the output file or None (default),
                where None yields sys.stdout.
        """
        self.assert_experiment_exists(experiment_name)
        if output_file is not None:
            experiment_root = self._path
