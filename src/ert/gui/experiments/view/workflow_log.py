...
class WorkflowLogWidget(QWidget):
    ...
    Rows are added from :class:`RunModelWorkflowLogEvent`s, one row per job
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self._events: dict[int | None, list[RunModelWorkflowLogEvent]] = {}
    ...
    def add_event(self, event: RunModelWorkflowLogEvent) -> None:
    ...
    def _group_key(self, event: RunModelWorkflowLogEvent) -> int | None:
    ...
    def _append_row(self, event: RunModelWorkflowLogEvent) -> None:
    ...
    def _status_and_color(self, event: RunModelWorkflowLogEvent) -> tuple[str, QColor]:
        if event.cancelled:
