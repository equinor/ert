...
class ExperimentMetadata {
  ...
  eachEnsemble(f) {
    Object.keys(this.ensembles).forEach((ensembleId) => {
      const ensembleAlias = this.ensembleIdToAlias(ensembleId);
      f(ensembleId, ensembleAlias);
    });
  }
  sortedEnsembles() {
    const keys = Object.keys(this.ensembles);
    return keys.sort((a, b) => this.ensembles[b].iteration - this.ensembles[a].iteration).map((k) => this.ensembles[k]);
  }
}
...
function axis(orient, scale) {
  ...
  function axis2(context) {
    var values = tickValues == null ? scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain() : tickValues, format2 = tickFormat2 == null ? scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity$3 : tickFormat2, spacing = Math.max(tickSizeInner, 0) + tickPadding, range = scale.range(), range0 = +range[0] + offset2, range1 = +range[range.length - 1] + offset2, position = (scale.bandwidth ? center : number$1)(scale.copy(), offset2), selection2 = context.selection ? context.selection() : context, path = selection2.selectAll(".domain").data([null]), tick2 = selection2.selectAll(".tick").data(values, scale).order(), tickExit = tick2.exit(), tickEnter = tick2.enter().append("g").attr("class", "tick"), line2 = tick2.select("line"), text2 = tick2.select("text");
...
function transformer() {
  var domain = unit, range = unit, interpolate2 = interpolate$1, transform, untransform, unknown, clamp2 = identity, piecewise, output, input;
  function rescale() {
...
function instance$a($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("domainX" in $$props2)
      $$invalidate(5, domainX = $$props2.domainX);
    if ("ticksY" in $$props2)
      $$invalidate(6, ticksY = $$props2.ticksY);
    if ("formatY" in $$props2)
      $$invalidate(7, formatY = $$props2.formatY);
    if ("ticksX" in $$props2)
      $$invalidate(8, ticksX = $$props2.ticksX);
    if ("formatX" in $$props2)
      $$invalidate(9, formatX = $$props2.formatX);
  };
  return [
    height,
    axisXContainer,
...
function create_if_block$4(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      1 && g_transform_value !== (g_transform_value = `translate(${/*axisMarginLeft*/
      ctx2[0]},0)`)) {
...
function create_fragment$a(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*width, axisMarginLeft, height, axisMarginBottom, data, sharedDomainX, sharedDomainY, style*/
      1011) {
...
function instance$9($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("showAxisX" in $$props2)
      $$invalidate(2, showAxisX = $$props2.showAxisX);
    if ("showAxisY" in $$props2)
      $$invalidate(3, showAxisY = $$props2.showAxisY);
    if ("data" in $$props2)
    ...
    if ("spec" in $$props2)
      $$invalidate(10, spec = $$props2.spec);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*data*/
    16) {
      $$invalidate(9, sharedDomainY = () => {
...
function create_fragment$9(ctx) {
  ...
  return {
    c() {
      ...
      attr(label_1, "class", "input__label svelte-p6dmqw");
      ...
      attr(input, "class", "input__field svelte-p6dmqw");
      attr(div, "class", "input svelte-p6dmqw");
    },
    m(target, anchor2) {
...
function instance$8($$self, $$props, $$invalidate) {
  ...
  return [id2, label2, placeholder];
}
class TextInput extends SvelteComponent {
  constructor(options) {
    super();
    init$1(this, options, instance$8, create_fragment$9, safe_not_equal, { id: 0, label: 1, placeholder: 2 });
  }
}
...
const MOUNTING_POINT = document.querySelector("#portal");
const portal = (element2) => {
  const update2 = async () => {
    if (!MOUNTING_POINT) {
      await tick();
    }
    MOUNTING_POINT == null ? void 0 : MOUNTING_POINT.appendChild(element2);
  };
  const destroy = async () => {
...
class Icon extends SvelteComponent {
  constructor(options) {
    super();
    init$1(this, options, instance$7, create_fragment$8, safe_not_equal, { name: 4, color: 0, width: 1, height: 2 });
  }
}
...
class Chip extends SvelteComponent {
  constructor(options) {
    super();
    init$1(this, options, instance$6, create_fragment$7, safe_not_equal, { label: 0 });
  }
}
...
function create_if_block_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty & /*$selected, onChipRemove*/
      131088) {
...
function create_if_block$2(ctx) {
  ...
  let ul_levels = [
    {
      class: "flex flex-col p-2 max-h-72 gap-1 combobox__option-list"
    },
    /*$menu*/
    ctx[8]
  ];
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      514) {
        ...
        each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx2, each_value, each_1_lookup, ul, destroy_block, create_each_block$2, null, get_each_context$2);
...
function create_each_block$2(key_1, ctx) {
  ...
  let li_levels = [
    {
      class: "flex items-center relative px-3 scroll-my-2 min-h-10 combobox__option"
    },
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      set_attributes(li, li_data = get_spread_update(li_levels, [
        ...
        dirty & /*$option, options*/
        514 && /*__MELTUI_BUILDER_0__*/
        ctx[22]
      ]));
      toggle_class(li, "svelte-1jajbrv", true);
    },
    ...
    m(target, anchor2) {
      ...
      if (!mounted) {
        dispose = [
          action_destroyer(
            /*$inputLabel*/
            ctx[6].action(label_1)
          ),
          action_destroyer(
            /*$input*/
            ctx[7].action(input_1)
          )
        ];
        mounted = true;
      }
...
function instance$5($$self, $$props, $$invalidate) {
  ...
  const { elements: { menu: menu2, input, option, label: inputLabel }, states: { open, inputValue, selected } } = createCombobox({
    ...
    onSelectedChange: ({ next: next2 }) => {
      $$invalidate(18, value = next2);
      dispatch2("change", { value: next2 });
      return next2;
    },
    defaultSelected: value
  });
  component_subscribe($$self, menu2, (value2) => $$invalidate(8, $menu = value2));
  component_subscribe($$self, input, (value2) => $$invalidate(7, $input = value2));
  component_subscribe($$self, option, (value2) => $$invalidate(9, $option = value2));
  component_subscribe($$self, inputLabel, (value2) => $$invalidate(6, $inputLabel = value2));
  component_subscribe($$self, open, (value2) => $$invalidate(5, $open = value2));
  component_subscribe($$self, inputValue, (value2) => $$invalidate(19, $inputValue = value2));
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*multiselect, $open, $selected*/
    56) {
      if (!multiselect && !$open) {
...
function fallback_block_1(ctx) {
  ...
  return {
    c() {
      ...
      ctx[1] ? "Button is pressed" : "Button is not pressed");
    },
    m(target, anchor2) {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty & /*open*/
      2 && button_aria_label_value !== (button_aria_label_value = /*open*/
      ctx2[1] ? "Button is pressed" : "Button is not pressed")) {
...
function fallback_block(ctx) {
  ...
  return {
    c() {
      div = element("div");
      div.textContent = 'Add controls to the \\"controls\\" slot';
      attr(div, "class", "flex flex-col gap-4 px-3 min-w-96");
    },
    m(target, anchor2) {
      insert(target, div, anchor2);
    },
...
function create_fragment$5(ctx) {
  ...
  if (
    ...
    combobox_props.value = /*experiments*/
    ctx[0][0];
  }
  ...
  const controls_slot_or_fallback = controls_slot || fallback_block();
  return {
    c() {
      div2 = element("div");
      ...
      attr(div0, "class", div0_class_value = null_to_empty([
        "fixed top-0 left-0 h-dvh w-dvw sidebar-backdrop",
        /*open*/
        ctx[1] && "sidebar-backdrop--visible"
      ].filter(Boolean).join(" ")) + " svelte-1mtj1d8");
      attr(ul, "class", "p-2 min-w-60 sidebar__experiments svelte-1mtj1d8");
      attr(nav, "class", nav_class_value = null_to_empty([
        "fixed flex top-0 left-0 h-dvh sidebar",
        /*open*/
        ctx[1] && "sidebar--open"
      ].filter(Boolean).join(" ")) + " svelte-1mtj1d8");
    },
    m(target, anchor2) {
      insert(target, div2, anchor2);
      if (open_button_slot_or_fallback) {
        open_button_slot_or_fallback.m(div2, null);
      }
      append$1(div2, t0);
      append$1(div2, div1);
      append$1(div1, div0);
      ...
      append$1(div1, nav);
      append$1(nav, ul);
      mount_component(combobox, ul, null);
      append$1(nav, t2);
      if (controls_slot_or_fallback) {
        controls_slot_or_fallback.m(nav, null);
      }
      current = true;
      if (!mounted) {
        dispose = [
          ...
          action_destroyer(portal.call(null, div1))
        ];
        mounted = true;
      }
    },
    p(ctx2, [dirty]) {
      if (open_button_slot) {
        ...
        if (open_button_slot_or_fallback && open_button_slot_or_fallback.p && (!current || dirty & /*open*/
        2)) {
      ...
      2 && div0_class_value !== (div0_class_value = null_to_empty([
        "fixed top-0 left-0 h-dvh w-dvw sidebar-backdrop",
        /*open*/
        ctx2[1] && "sidebar-backdrop--visible"
      ].filter(Boolean).join(" ")) + " svelte-1mtj1d8")) {
      ...
      1)
        combobox_changes.options = /*experiments*/
        ctx2[0];
      if (!updating_value && dirty & /*experiments*/
      1) {
        updating_value = true;
        combobox_changes.value = /*experiments*/
        ctx2[0][0];
      ...
      if (!current || dirty & /*open*/
      2 && nav_class_value !== (nav_class_value = null_to_empty([
        "fixed flex top-0 left-0 h-dvh sidebar",
        /*open*/
        ctx2[1] && "sidebar--open"
      ].filter(Boolean).join(" ")) + " svelte-1mtj1d8")) {
...
function instance$4($$self, $$props, $$invalidate) {
  ...
  let { experiments = [
    {
      label: "Snaik oil",
      value: "asdaskjd-fdsf-sdfdsfsd"
    },
    {
      label: "Dogran",
      value: "dsafsdfds-fdsf-sdfdsfsd"
    },
    {
      label: "Dogron ESMDA",
      value: "gjdnfksdnk-fdsf-sdfdsfsd"
    }
  ] } = $$props;
  let { experiment = false } = $$props;
  let open = false;
  ...
  function combobox_value_binding(value) {
    if ($$self.$$.not_equal(experiments[0], value)) {
      experiments[0] = value;
      $$invalidate(0, experiments);
    }
  }
  $$self.$$set = ($$props2) => {
    if ("experiments" in $$props2)
      $$invalidate(0, experiments = $$props2.experiments);
    if ("experiment" in $$props2)
      $$invalidate(3, experiment = $$props2.experiment);
    if ("$$scope" in $$props2)
...
class Sidebar extends SvelteComponent {
  constructor(options) {
    super();
    init$1(this, options, instance$4, create_fragment$5, safe_not_equal, { experiments: 0, experiment: 3 });
  }
}
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("y0" in $$props2)
      $$invalidate(2, y0 = $$props2.y0);
    if ("x0" in $$props2)
      $$invalidate(3, x0 = $$props2.x0);
    if ("width" in $$props2)
      $$invalidate(4, width = $$props2.width);
    if ("height" in $$props2)
      $$invalidate(5, height = $$props2.height);
    if ("domainY" in $$props2)
      $$invalidate(6, domainY = $$props2.domainY);
    if ("domainX" in $$props2)
      $$invalidate(7, domainX = $$props2.domainX);
    if ("sharedDomainX" in $$props2)
      $$invalidate(8, sharedDomainX = $$props2.sharedDomainX);
    if ("sharedDomainY" in $$props2)
      $$invalidate(9, sharedDomainY = $$props2.sharedDomainY);
    if ("points" in $$props2)
      $$invalidate(10, points = $$props2.points);
    if ("realization" in $$props2)
      $$invalidate(11, realization = $$props2.realization);
    if ("style" in $$props2)
      $$invalidate(0, style2 = $$props2.style);
  };
  $$self.$$.update = () => {
    ...
    1840) {
      $$invalidate(1, compute = () => {
        ...
        const scaleX = (x2) => scaleXSharedToViewport(scaleXNormalizedToShared(x2));
        const scaleY = (y2) => scaleYSharedToViewport(scaleYNormalizedToShared(y2));
        const lineGenerator = area().x((d) => scaleX(d[0])).y1((d) => scaleY(d[1])).y0(scaleY(0)).curve(basis);
        const lineDataString = lineGenerator(points);
        if (!lineDataString) {
          throw new Error("Failed to create line from data");
        }
...
const kde = (ds, bandwidth, kernelFunction, numPoints) => {
  ...
  return {
    kdeValues: xValues.map((x2, i2) => [(x2 - minX) / spanX, kdeValues[i2]]),
    domainY,
    domainX
  };
};
...
function create_if_block$1(ctx) {
  ...
  singleaxislayer = new SingleAxisLayer({
    props: {
      width: (
        /*width*/
        ctx[5] - /*axisMarginLeft*/
        ctx[0]
      ),
      height: (
        /*height*/
        ctx[6] - /*axisMarginBottom*/
        ctx[1]
      ),
      domainX: (
        /*kdeCharts*/
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      33)
        singleaxislayer_changes.width = /*width*/
        ctx2[5] - /*axisMarginLeft*/
        ctx2[0];
      if (dirty & /*height, axisMarginBottom*/
      66)
        singleaxislayer_changes.height = /*height*/
        ctx2[6] - /*axisMarginBottom*/
        ctx2[1];
      if (dirty & /*kdeCharts*/
      128)
        singleaxislayer_changes.domainX = /*kdeCharts*/
        ctx2[7]().sharedDomainX;
      if (dirty & /*kdeCharts*/
      128)
        singleaxislayer_changes.domainY = /*kdeCharts*/
        ctx2[7]().sharedDomainY;
      singleaxislayer.$set(singleaxislayer_changes);
      if (!current || dirty & /*axisMarginLeft*/
      1 && g_transform_value !== (g_transform_value = `translate(${/*axisMarginLeft*/
      ctx2[0]},0)`)) {
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("style" in $$props2)
      $$invalidate(4, style2 = $$props2.style);
    if ("width" in $$props2)
...
function create_then_block$1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div2, "class", "relative w-full h-full shadow-lg rounded m-5");
    },
    m(target, anchor2) {
      insert(target, div2, anchor2);
      append$1(div2, div0);
      ...
      if (!mounted) {
        dispose = [
          action_destroyer(watchResize.call(null, div1)),
          listen(
            div1,
            "resized",
            /*onResize*/
    ...
    p(ctx2, dirty) {
      if ((!current || dirty & /*performanceInfo*/
      16) && t0_value !== (t0_value = /*performanceInfo*/
      ctx2[4]() + ""))
        set_data(t0, t0_value);
...
function create_controls_slot(ctx) {
  ...
  combobox0 = new Combobox({
    props: {
      ...
      options: [{ value: "ens1", label: "ensemble 1" }],
      multiselect: true
    }
  });
  ...
  combobox1 = new Combobox({
    props: {
      label: "Summary",
      placeholder: "Select summary keyword…",
      options: [{ value: "ens1", label: "ensemble 1" }]
    }
  });
  return {
    ...
    m(target, anchor2) {
      insert(target, div, anchor2);
      mount_component(combobox0, div, null);
      append$1(div, t0);
      mount_component(textinput, div, null);
      append$1(div, t1);
      mount_component(combobox1, div, null);
      current = true;
    },
    p: noop$2,
    i(local) {
  ...
  function switch_props(ctx2, dirty) {
    return {
      props: {
        ...
        width: (
          /*containerWidth*/
          ctx2[2] - /*axisMarginLeft*/
          ctx2[0]
        ),
        height: (
          /*containerHeight*/
          ctx2[3] - /*axisMarginBottom*/
          ctx2[1]
        )
      }
    };
...
function create_fragment$2(ctx) {
  ...
  return {
    ...
    m(target, anchor2) {
      insert(target, await_block_anchor, anchor2);
      info.block.m(target, info.anchor = anchor2);
    ...
    p(new_ctx, [dirty]) {
      ...
      64 && promise !== (promise = Promise.all([
        /*ensureComponentDataIsLoaded*/
        ctx[6](),
        /*ensureExperimentIsSelected*/
        ctx[7]()
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  let performanceInfo;
  let $plotterStore;
  component_subscribe($$self, plotterStore, ($$value) => $$invalidate(13, $plotterStore = $$value));
  let { axisMarginLeft = 35 } = $$props;
  let { axisMarginBottom = 35 } = $$props;
  let { showAxisX = true } = $$props;
  let { showAxisY = true } = $$props;
  ...
  const ensureExperimentIsSelected = async () => {
    ...
    if (spec.query.experiment === "auto")
      $$invalidate(10, spec.query.experiment = Object.keys(metadata)[0], spec);
  };
  ...
  const findComponentAndDataInfo = () => {
    ...
    throw new TypeError(`Expected valid dataset kind, got ${kind}, expected 'summary' or 'parameter'`);
  };
  ...
  const onResize = (event) => {
    ...
    $$invalidate(2, containerWidth = width);
    $$invalidate(3, containerHeight = height);
  };
  $$self.$$set = ($$props2) => {
    if ("axisMarginLeft" in $$props2)
      $$invalidate(0, axisMarginLeft = $$props2.axisMarginLeft);
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*spec*/
    1024) {
      $$invalidate(6, ensureComponentDataIsLoaded = async () => {
    ...
    9216) {
      $$invalidate(5, computeEnsembleStyleMap = () => {
        const style2 = spec.style || {};
        const stylePerEnsemble = {};
        const experiment = getLoadedExperiments()[spec.query.experiment];
        experiment.eachEnsemble((ensembleId, ensembleAlias) => {
          stylePerEnsemble[ensembleAlias] = stylePerEnsemble[ensembleId] = {};
          const globalStyle = $plotterStore.style;
          Object.keys(globalStyle).filter((k) => k.startsWith("ensemble:")).filter((k) => k === ensembleAlias).forEach((k) => Object.assign(stylePerEnsemble[ensembleAlias], globalStyle[k]));
          Object.keys(style2 || {}).filter((k) => k.startsWith("ensemble:")).filter((k) => k === ensembleAlias).forEach((k) => Object.assign(stylePerEnsemble[ensembleAlias], style2[k]));
        });
        return stylePerEnsemble;
      });
    }
  };
  $$invalidate(4, performanceInfo = () => {
    const summary = findComponentAndDataInfo();
    const { timeSpentSeconds, MBProcessed } = summary;
    return `Spent ${timeSpentSeconds.toFixed(4)} seconds to load a ${summary.data.length} realizations over ${MBProcessed}MB of files`;
  });
  return [
    axisMarginLeft,
    axisMarginBottom,
...
function create_each_block(ctx) {
  ...
  let updating_spec;
  let current;
  function generalchartview_spec_binding(value) {
    ctx[1](
      value,
      /*spec*/
      ctx[2],
  ...
  let generalchartview_props = {};
  if (
    /*spec*/
    ctx[2] !== void 0
  ) {
    generalchartview_props.spec = /*spec*/
    ctx[2];
  }
  generalchartview = new GeneralChartView({ props: generalchartview_props });
  binding_callbacks.push(() => bind(generalchartview, "spec", generalchartview_spec_binding));
  return {
    c() {
    ...
    p(new_ctx, dirty) {
      ctx = new_ctx;
      const generalchartview_changes = {};
      if (!updating_spec && dirty & /*$plotterStore*/
      1) {
        updating_spec = true;
        generalchartview_changes.spec = /*spec*/
        ctx[2];
        add_flush_callback(() => updating_spec = false);
      }
      generalchartview.$set(generalchartview_changes);
    },
    i(local) {
      if (current)
        return;
...
function instance($$self, $$props, $$invalidate) {
  ...
  function generalchartview_spec_binding(value, spec, each_value, spec_index) {
    each_value[spec_index] = value;
    plotterStore.set($plotterStore);
  }
  return [$plotterStore, generalchartview_spec_binding];
}
...
//# sourceMappingURL=index-tuoSRk5y.js.map
