...
class ManageExperimentsPanel(QTabWidget):
    ...
    def _add_initialize_from_scratch_tab(self) -> None:
        ...
        parameters = self.ert_config.ensemble_config.parameters
        ...
        if design_matrix is not None:
            try:
                ...
                QMessageBox.warning(
                    ...
                    "Warning",
                    (
                        "The following issue were found when merging GenKW "
        ...
        def initialize_from_scratch(_: bool) -> None:
            ...
            design_matrix = self.ert_config.analysis_config.design_matrix
            if design_matrix is not None and design_matrix_group is not None:
