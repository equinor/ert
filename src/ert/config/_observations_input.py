...
from .parsing import ErrorInfo, ObservationConfigError, ObservationType
...
def validate_observations_input(
    directory: str,
    inp: Sequence[
        tuple[Literal[ObservationType.HISTORY], str]
        | tuple[ObservationType, str, dict[str, Any]]
    ],
) -> ConfContent:
...
def _validate_history_values(name_token: str, inp: dict[str, Any]) -> HistoryValues:
...
def _validate_summary_values(name_token: str, inp: dict[str, Any]) -> SummaryValues:
...
def _validate_gen_obs_values(
    directory: str, name_token: str, inp: dict[str, Any]
) -> GenObsValues:
    try:
        data = inp[cast(str, "DATA")]
...
def _unknown_declaration_error(
    decl: tuple[Literal[ObservationType.HISTORY], str]
    | tuple[ObservationType, str, Any],
