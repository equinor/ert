...
class AnalysisConfig:
    ...
    parameter_settings: dict[str, StrategyName] = field(default_factory=dict)
    ...
    def from_dict(cls, config_dict: ConfigDict) -> AnalysisConfig:
        ...
        errors = []
        all_errors = []
        parameter_settings: dict[str, StrategyName] = {}
        ...
        for module_name, var_name, value in analysis_set_var:
            if module_name == "PARAMETERS":
                ...
                parameter_settings[parameter_type] = strategy_name
                continue
