    ...
    def run_experiment(
        ...
        if self.restart_run:
            ...
            try:
                ...
                # As this is a restart we must update the active realizations
                # to only use valid realizations from the parent ensemble
                self.active_realizations = list(
                    set(
                    ...
                    ).intersection(self.active_realizations)
                )
