...
def create_model(
    ...
    if hasattr(args, "prior_case") and args.prior_case is not None:
        prior_case = args.prior_case
        prior_ensemble = storage.get_ensemble_by_name(prior_case)
    ...
    if args.mode == "test_run":
        ...
        return _setup_multiple_data_assimilation(
            ert, storage, args, experiment_id, prior_ensemble
        )
