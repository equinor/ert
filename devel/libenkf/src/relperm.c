...
int relperm_serialize(const relperm_type *relperm , int internal_offset , size_t serial_data_size , double *serial_data , size_t stride , size_t offset, bool * complete) {
  DEBUG_ASSERT(relperm);
  return scalar_serialize(relperm->scalar , internal_offset , serial_data_size , serial_data , stride , offset , complete);
}

int relperm_deserialize(relperm_type *relperm , int internal_offset , size_t serial_size , const double * serial_data , size_t stride , size_t offset) {
  DEBUG_ASSERT(relperm);
  return scalar_deserialize(relperm->scalar , internal_offset , serial_size , serial_data , stride , offset);
}
