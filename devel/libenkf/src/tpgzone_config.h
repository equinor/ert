...
struct tpgzone_config_struct
{
  ...
  hash_type                 * facies_kw;            /* Hash with the name of the facies */
  scalar_config_type        * poro;                 /* Poro output transform for each facies */
  scalar_config_type        * permx;                /* Permx output transform for each facies */
  scalar_config_type        * permz;                /* Permx output transform for each facies */
