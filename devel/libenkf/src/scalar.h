...
int              scalar_serialize(const scalar_type * , size_t , double *, size_t , size_t, serial_state_type * );
void             scalar_deserialize(scalar_type * , const double * , size_t , serial_state_type * );
