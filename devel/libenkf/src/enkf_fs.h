...
void             enkf_fs_fread_obs_node(enkf_fs_type *  , obs_node_type * , int );
void             enkf_fs_fwrite_obs_node(enkf_fs_type *  , obs_node_type * , int );
bool             enkf_fs_has_obs_node(enkf_fs_type *  , obs_node_type * , int );
