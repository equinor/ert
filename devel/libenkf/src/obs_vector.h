...
obs_vector_type    * obs_vector_alloc_from_HISTORY_OBSERVATION(const conf_instance_type *  , const history_type * , ensemble_config_type * );
...
double               obs_vector_chi2(const obs_vector_type *  , enkf_fs_type *  , int  , int );
void                 obs_vector_ensemble_chi2(const obs_vector_type *  , enkf_fs_type * , int  , int , double * );
