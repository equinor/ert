...
ert_template_type * ert_template_alloc( const char * template_file , const char * target_file, subst_func_pool_type * subst_func_type) ;
...
ert_templates_type * ert_templates_alloc(subst_func_pool_type * subst_func_type);
