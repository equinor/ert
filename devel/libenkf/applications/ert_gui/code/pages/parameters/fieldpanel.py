...
class FieldPanel(QtGui.QFrame):
    ...
    def __init__(self, parent):
        ...
        self.min.setter = lambda model, value: self.fieldModel.set("min", value)
        self.min.getter = lambda model: self.fieldModel["min"]


        self.max = DoubleBox(self, "", "field_max")
        self.max.setter = lambda model, value: self.fieldModel.set("max", value)
        ...
        self.init.setter = lambda model, value: self.fieldModel.set("init", value)
        ...
        self.output.setter = lambda model, value: self.fieldModel.set("output", value)
        self.output.getter = lambda model: self.fieldModel["output"]

        self.init_files = PathChooser(self, "", "field_init_files", True)
        self.init_files.setter = lambda model, value: self.fieldModel.set("init_files", value)
        ...
        self.file_generated_by_enkf.setter = lambda model, value: self.fieldModel.set("file_generated_by_enkf", value)
        ...
        self.file_loaded_by_enkf.setter = lambda model, value: self.fieldModel.set("file_loaded_by_enkf", value)
