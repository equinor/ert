...
typedef struct std_enkf_data_struct std_enkf_data_type;
  ...
  void     std_enkf_initX(void * module_data , matrix_type * X , matrix_type * A , matrix_type * S , matrix_type * R , matrix_type * innov , matrix_type * E , matrix_type *D , matrix_type * randrot);
