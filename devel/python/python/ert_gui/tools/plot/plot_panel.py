...
class PlotWebView(QWebView):
    def __init__(self, name):
        ...
        self.__web_inspector = QWebInspector()
        self.__web_inspector.setPage(self.page())
        ...
        self.__inspector_window.setCentralWidget(self.__web_inspector)
...
class PlotPanel(QWidget):
    ...
    def supportsPlotProperties(self, time=False, value=False, depth=False, index=False, histogram=False):
        return self.__plot_bridge.supportsPlotProperties(time, value, depth, index, histogram)
