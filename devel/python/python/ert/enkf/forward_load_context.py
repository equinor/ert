...
class ForwardLoadContext(BaseCClass):
    ...
    _alloc = EnkfPrototype("void* forward_load_context_alloc( run_arg , bool , ecl_config , char* , stringlist )")
    ...
    def getLoadStep( self ):
        return self._get_step( self )


    def selectStep(self , report_step):
        self._select_step( self , report_step) 
