...
class EnKFMain(BaseCClass):
    ...
    def fieldInitFile(self , config_node):
        ...
        # The underlying C function will allocate a naked char*
        # pointer, the normal Python memory managment system will not
        # free it; it must be manually free'd manually:
        #
        #    init_file = ert.fieldInitFile( config_node )
        #    ...
