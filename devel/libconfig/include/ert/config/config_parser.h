...
/*****************************************************************/
  ...
  */
  ...
  const char            * config_iget(const config_parser_type * , const char * , int occurence , int index);
  bool                    config_iget_as_bool(const config_parser_type * , const char * , int occurence , int index);
  double                  config_iget_as_double(const config_parser_type * , const char * , int occurence , int index);
  int                     config_iget_as_int(const config_parser_type * , const char *, int occurence , int index);
