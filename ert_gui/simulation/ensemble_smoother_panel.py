...
class EnsembleSmootherPanel(SimulationConfigPanel):
    def __init__(self, ert, notifier):
        ...
        self._case_selector = CaseSelector(LibresFacade(ert), notifier)
        ...
        self._target_case_model = TargetCaseModel(LibresFacade(self.ert), notifier)
        ...
        active_realizations_model = ActiveRealizationsModel(LibresFacade(ert))
