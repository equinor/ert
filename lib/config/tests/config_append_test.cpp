...
int main(int argc , char ** argv) {
  ...
  {
    config_content_type * content = config_parse(config , config_file , "--" , NULL , NULL , NULL , CONFIG_UNRECOGNIZED_IGNORE, true );
  ...
  {
    config_content_type * content = config_parse( config , "DoesNotExist" , "--" , NULL , NULL , NULL , CONFIG_UNRECOGNIZED_IGNORE, true);
