...
void set_option_max_running_max_running_value_set() {
  ...
  test_assert_string_equal("42", (const char *) queue_driver_get_option(driver_torque, MAX_RUNNING));
  ...
  test_assert_string_equal("72", (const char *) queue_driver_get_option(driver_lsf, MAX_RUNNING));
...
void set_option_valid_on_specific_driver_returns_true() {
  ...
  test_assert_string_equal("33", (const char *) queue_driver_get_option(driver_torque, TORQUE_NUM_CPUS_PER_NODE));
  queue_driver_free(driver_torque);
}
