...
from res.job_queue import JOB_QUEUE_LIB
...
JobStatusType.addEnum("JOB_QUEUE_RUNNING_DONE_CALLBACK", 32768)
JobStatusType.addEnum("JOB_QUEUE_RUNNING_EXIT_CALLBACK", 65536)
JobStatusType.addEnum("JOB_QUEUE_RUNNING_KILL_CALLBACK", 131072)
JobStatusType.addEnum("JOB_QUEUE_FAILED", 524288)
JobStatusType.addEnum("JOB_QUEUE_DO_KILL_NODE_FAILURE", 1048576)
