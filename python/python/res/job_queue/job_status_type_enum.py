...
class JobStatusType(BaseCEnum):
    ...
    JOB_QUEUE_RUNNING_KILL_CALLBACK = None
...
JobStatusType.addEnum("JOB_QUEUE_RUNNING_KILL_CALLBACK", 4096)
JobStatusType.addEnum("JOB_QUEUE_STATUS_FAILURE", 8192)
JobStatusType.addEnum("JOB_QUEUE_FAILED", 16384)
JobStatusType.addEnum("JOB_QUEUE_DO_KILL_NODE_FAILURE", 32768)
