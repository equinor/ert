...
class UIReturn(BaseCClass):
    ...
    _alloc       = ResUtilPrototype("void* ui_return_alloc( ui_return_status )" , bind = False)
    _free        = ResUtilPrototype("void ui_return_free(ui_return)")
    _get_status  = ResUtilPrototype("ui_return_status ui_return_get_status(ui_return)")
    _get_help    = ResUtilPrototype("char* ui_return_get_help(ui_return)")
    _add_help    = ResUtilPrototype("void ui_return_add_help(ui_return)")
    _add_error   = ResUtilPrototype("void ui_return_add_error(ui_return)")
    _num_error   = ResUtilPrototype("int ui_return_get_error_count(ui_return)")
    _last_error  = ResUtilPrototype("char* ui_return_get_last_error(ui_return)")
    _first_error = ResUtilPrototype("char* ui_return_get_first_error(ui_return)")
    _iget_error  = ResUtilPrototype("char* ui_return_iget_error(ui_return ,       int)")
