...
class SchemaItem(BaseCClass):
    ...
    _iget_type = ResPrototype("config_content_type_enum config_schema_item_iget_type( schema_item, int)")
    _iset_type = ResPrototype("void config_schema_item_iset_type( schema_item , int , config_content_type_enum)")
    _set_argc_minmax = ResPrototype("void config_schema_item_set_argc_minmax( schema_item , int , int)")
    _add_alternative = ResPrototype("void config_schema_item_add_indexed_alternative(schema_item , int , char*)")
    _set_deprecated = ResPrototype("void config_schema_item_set_deprecated(schema_item ,  char*)")
