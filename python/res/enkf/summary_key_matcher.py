...
class SummaryKeyMatcher(BaseCClass):
    ...
    _add_key     = ResPrototype("void  summary_key_matcher_add_summary_key(summary_key_matcher, char*)")
    _match_key   = ResPrototype("bool  summary_key_matcher_match_summary_key(summary_key_matcher, char*)")
    _keys        = ResPrototype("stringlist_obj summary_key_matcher_get_keys(summary_key_matcher)")
    _is_required = ResPrototype("bool  summary_key_matcher_summary_key_is_required(summary_key_matcher, char*)")
