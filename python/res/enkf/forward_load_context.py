...
class ForwardLoadContext(BaseCClass):
    ...
    _alloc = ResPrototype("void* forward_load_context_alloc( run_arg , bool , ecl_config , char* , stringlist )" , bind = False)
    _select_step = ResPrototype("void forward_load_context_select_step( forward_load_context , int )")
    _get_step = ResPrototype("int forward_load_context_get_load_step( forward_load_context)")
