...
class ErtWorkflowList(BaseCClass):
    ...
    _alloc          = ResPrototype("void* ert_workflow_list_alloc(subst_list, config_content)", bind=False)
    _alloc_full      = ResPrototype("void* ert_workflow_list_alloc_full(subst_list, workflow_joblist)", bind=False)
    ...
    _add_workflow   = ResPrototype("workflow_ref ert_workflow_list_add_workflow(ert_workflow_list, char*, char*)")
    ...
    def __eq__(self, other):
        ...
        for name_self, name_other in zip(sorted(self.getJobNames()), sorted(other.getJobNames()) ):
        ...
        for name_self, name_other in zip(self.getWorkflowNames(), other.getWorkflowNames()):
