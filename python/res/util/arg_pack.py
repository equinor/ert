...
class ArgPack(BaseCClass):
    ...
    _alloc = ResPrototype("void* arg_pack_alloc()" , bind = False)
    _append_int = ResPrototype("void arg_pack_append_int(arg_pack, int)")
    _append_double = ResPrototype("void arg_pack_append_double(arg_pack, double)")
    _append_ptr = ResPrototype("void arg_pack_append_ptr(arg_pack, void*)")

    _size = ResPrototype("int arg_pack_size(arg_pack)")
    _free = ResPrototype("void arg_pack_free(arg_pack)")
